  ...
  return (
    <div className="min-h-screen grid place-items-center">
      <form onSubmit={onSubmit} className="w-full max-w-md rounded-lg bg-white p-8 shadow">
        <h1 className="text-3xl mb-6">Login to North</h1>
        ...
        <button className="w-full bg-zinc-900 text-white rounded p-2">Login</button>
        <p className="text-sm mt-4">No account? <Link className="text-gold" href="/signup">Sign up</Link></p>
      </form>
    </div>
  );
}
